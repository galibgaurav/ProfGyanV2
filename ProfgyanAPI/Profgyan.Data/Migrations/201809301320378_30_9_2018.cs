namespace Profgyan.Data.Migrations
{
    ...
    public partial class _30_9_2018 : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        HighestQualification = c.String(maxLength: 50),
                ...
                c => new
                    {
                        ...
                        UserIdentity = c.String(maxLength: 50),
                    })
            ...
            CreateTable(
                "dbo.ValidationPasscodes",
                c => new
                    {
                        validationElement = c.String(nullable: false, maxLength: 128),
                        passcode = c.String(),
                        createdTime = c.DateTime(),
                        expiryTime = c.DateTime(),
                    })
                .PrimaryKey(t => t.validationElement);
        ...
        public override void Down()
        {
            ...
            DropTable("dbo.ValidationPasscodes");
